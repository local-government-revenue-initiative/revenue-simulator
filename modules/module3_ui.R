    ...
    fluidRow(
      box(
        ...
        tabsetPanel(id = ns("tax_tabs"),
                    ...
                    tabPanel("Save/Load Configurations",
                      br(),
                      fluidRow(
                        column(12,
                                h3("Save and Load Tax Configuration Settings"),
                                p("Use these controls to save your current tax rate and minimum settings to JSON files, or load previously saved configurations."),
                                p("Saved configurations include: property tax rates and minimums (including progressive slots if enabled), and all business license parameters."),
                      ...
                      fluidRow(
                        ...
                        column(4,
                                box(
                                  ...
                                  p("Save the current Existing Scenario tax settings to a JSON file.", 
                                  ...
                                  p("Load a previously saved configuration file.", 
                                    style = "font-size: 12px; color: #666;"),
                                  fileInput(
                        ...
                        column(4,
                                box(
                                  ...
                                  h5("Download Current Configuration"),
                                  p("Save the current Scenario A tax settings to a JSON file.", 
                                    style = "font-size: 12px; color: #666;"),
                                  downloadButton(
                        ...
                        column(4,
                                box(
                                  ...
                                  h5("Download Current Configuration"),
                                  p("Save the current Scenario B tax settings to a JSON file.", 
                                    style = "font-size: 12px; color: #666;"),
                                  downloadButton(
                      ...
                      fluidRow(
                        column(12,
                                box(
                                  ...
                                  tags$ol(
                                    tags$li("Navigate to the 'Property Tax' and 'Business License' tabs and configure all settings"),
                                    tags$li("Return to this 'Save/Load Configurations' tab"),
                                    tags$li("Click the 'Download' button for the scenario you want to save"),
                                    tags$li("A JSON file will be downloaded with a timestamped filename (e.g., module3_existing_20250117_143052.json)"),
                                    tags$li("Store this file in a safe location or share it with colleagues")
                                  ),
                                  ...
                                  tags$ol(
                                    tags$li("Click 'Browse...' under the scenario you want to load into"),
                                    tags$li("Select a previously saved JSON configuration file"),
                                    tags$li("The system will automatically update all parameters to match the saved configuration"),
                                    tags$li("A notification will confirm successful loading and show when the configuration was saved"),
                                    tags$li("Navigate to 'Property Tax' and 'Business License' tabs to see all updated parameters")
                                  ),
                                  ...
                                  h5("What Gets Saved"),
                                  tags$ul(
                                    tags$li(strong("Property Tax:"), " Minimum tax amounts, tax rates, progressive slot settings (if enabled)"),
                                    tags$li(strong("Business License:"), " Tax calculation methods, minimum amounts, tax rates, value bands, area bands"),
                                    tags$li(strong("All Scenarios:"), " Each scenario's settings are saved independently")
                                  ),
                                  ...
                                  h5("Tips"),
                                  tags$ul(
                                    tags$li(strong("Naming:"), " Downloaded files include the scenario name and timestamp for easy identification"),
                                    tags$li(strong("Cloning:"), " To clone Scenario A to Scenario B, download from A and upload to B"),
                                    tags$li(strong("Coordination:"), " Use with Module 2 save/load to maintain complete policy configurations"),
                                    tags$li(strong("Validation:"), " The system validates files to ensure they're Module 3 configurations"),
                                    tags$li(strong("Sharing:"), " JSON files can be emailed or stored in cloud drives for team collaboration")
                                  )
                                )
                        )
                      )
