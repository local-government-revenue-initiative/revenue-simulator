        ...
        tabsetPanel(id = ns("param_tabs"),
                    ...
                    tabPanel("Data Preview",
                     ...
                     tabPanel("Save/Load Configurations",
                            ...
                            fluidRow(
                                   column(12,
                                          h3("Save and Load Complete Configurations"),
                                          p("Use these controls to save your current parameter settings to JSON files, or load previously saved configurations."),
                                          p("Saved configurations include: base values, inflation adjustments, area weights, all feature weights, and all structure type weights."),
                            ...
                            fluidRow(
                                   ...
                                   column(4,
                                          ...
                                          p("Save the current Existing Scenario parameters to a JSON file.", 
                                                 style = "font-size: 12px; color: #666;"),
                                          downloadButton(
                                                 ns("download_config_existing"),
                                   ...
                                   column(4,
                                          ...
                                          h5("Download Current Configuration"),
                                          p("Save the current Scenario A parameters to a JSON file.", 
                                                 style = "font-size: 12px; color: #666;"),
                                          downloadButton(
                                                 ns("download_config_scenario_a"),
                                   ...
                                   column(4,
                                          ...
                                          h5("Download Current Configuration"),
                                          p("Save the current Scenario B parameters to a JSON file.", 
                                                 style = "font-size: 12px; color: #666;"),
                                          downloadButton(
                                                 ns("download_config_scenario_b"),
                            ...
                            fluidRow(
                                   column(12,
                                          ...
                                          tags$ol(
                                                 tags$li("Adjust all parameters (base value, inflation, area weight, feature weights, structure type weights) as desired"),
                                                 tags$li("Click the 'Download' button for the scenario you want to save"),
                                                 tags$li("A JSON file will be downloaded with a timestamped filename (e.g., module2_existing_20250117_143052.json)"),
                                          ...
                                          tags$ol(
                                                 ...
                                                 tags$li("Navigate through the tabs to see all updated parameters")
                                          ),
                                          ...
                                          tags$ul(
                                                 ...
                                                 tags$li(strong("Archiving:"), " Create a folder to organize configurations by policy scenario or date"),
                                                 tags$li(strong("Validation:"), " The system validates files to ensure they're Module 2 configurations"),
