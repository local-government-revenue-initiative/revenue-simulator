...
#' Generate business license UI for a subcategory
#' @param ns Namespace function
#' @param subcategory Subcategory name
#' @param scenario_suffix Scenario identifier
#' @param defaults Default values for this subcategory
#' @param category Optional category name
generate_business_license_ui <- function(
  ns,
  subcategory,
  scenario_suffix,
  defaults,
  ...
  wellPanel(
    ...
    selectInput(
      ...
      choices = c(
        ...
        "Flat amount from business value bands" = "flat_value_bands",
    ...
    # Method 3: Value bands (simplified - 3 bands)
    conditionalPanel(
      condition = paste0(
        "input['",
        ns(paste0(
      ...
      h6("Value-Based Flat Tax (3 bands):"),
      fluidRow(
        column(
          4,
          numericInput(
      ...
      fluidRow(
        column(4, p("Band 3: Above Band 2")),
        column(
          4,
          numericInput(
            ns(paste0(
    ...
    # Method 4: Area bands (simplified - 3 bands)
    conditionalPanel(
      condition = paste0(
        "input['",
        ns(paste0(
      ...
      h6("Area-Based Flat Tax (3 bands):"),
      fluidRow(
        column(
          4,
          numericInput(
